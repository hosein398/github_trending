package ir.oxima.githubtrending.other.components.fancybuttons;
...
public class FancyButton extends LinearLayout {
    ...
    private String mDefaultIconFont = "aw.ttf";
    private String mDefaultTextFont = "irsans_n.ttf";
    ...
    private void initAttributesArray(TypedArray attrsArray) {
        ...
        mTextAllCaps = attrsArray.getBoolean(R.styleable.FancyButtonsAttrs_fb_textAllCaps, true);
        mTextAllCaps = attrsArray.getBoolean(R.styleable.FancyButtonsAttrs_android_textAllCaps, true);
